...
while ($show = mysqli_fetch_array($find)){
 echo '<tr>
	...
	<td> '.$show["date"].' </td>
    <td> '.$show["comment"].' </td>
    <td> <a href="change.php?id='.$show["id"].'"><img src="../img/web_icons/triangular42.png" width="16" height="16" /></a></td>
    <td> <a href=delete.php?id='.$show["id"].'"><img src="../img/web_icons/cross97.png" width="16" height="16" /></a></td>
  </tr>';
}
